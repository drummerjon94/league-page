...
export const managers = [
     {
       ...
       "bio": "First-ever Toilet Bowl champ (which Sleeper has conveniently wiped).",
     ...
     },
     {
       ...
       "favoritePlayer": 5122, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
     ...
     {
       "managerID": "1014582897908596736",  // ID of the roster that the manager manages (look at the order of the power rankings graph)
       "name": "Jamie",
       "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
       "location": "England", // (optional)
       "bio": "New kid on the block. Joined the league in 2025.",
       ...
       "favoritePlayer": 5045, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
       "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
       "philosophy": "TBC.",
       "tradingScale": 5, // 1 - 10
       "preferredContact": "Sleeper", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
